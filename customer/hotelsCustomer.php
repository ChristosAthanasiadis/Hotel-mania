						...
						<div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
							...
							<nav class="main_nav">
								<ul class="d-flex flex-row align-items-start justify-content-start">
									...
									<li class="active"><a href="hotelsCustomer.php">Your booking</a></li>
									<li><a href="showCustomer.php">Hotels</a></li>
...
$(document).ready(function() {
			...
			$.ajax({
				...
				var output =
                "<thead><tr><th>Name</th><th>Address</th><th>City</th><th>Number Rooms</th><th>State</th><th>Zip</th><th>Wifi</th><th>Heating Type</th><th>Coolling Type</th><th>Price</th><th>Rooms Remeine</th><th>Image</th></thead><tbody>";
                for (var i in result) {
                output +=
				"<tr><td>" +
                    result[i].name +
